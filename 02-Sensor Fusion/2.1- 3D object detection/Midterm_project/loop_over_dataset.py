...
data_fullpath = os.path.join(os.path.dirname(
    os.path.realpath(__file__)), 'dataset', data_filename)
model = "darknet"
sequence = "1"
# # # objdet_pcl.py
# results_fullpath = os.path.join(os.path.dirname(os.path.realpath(
#     __file__)), 'results/' + model + '/results_sequence_' + sequence + '_' + model)
# # # objdet_detect.py
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(
    __file__)), 'results/fpn-resnet/results_sequence_1_resnet/')
