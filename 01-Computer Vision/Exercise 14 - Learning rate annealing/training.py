...
from utils import get_datasets, get_module_logger, display_metrics, create_network, LrLogger
...
def exponential_decay(model, callbacks, lr=0.001):
    ...
    scheduler = schedules.ExponentialDecay(
        lr, decay_steps=100, decay_rate=0.95)
...
if __name__ == '__main__':
    os.chdir(r"C:\Users\mohamre1\Documents\python\udacity\Self Driving car engineer\Computer Vision\Exercise 14 - Learning rate annealing")
