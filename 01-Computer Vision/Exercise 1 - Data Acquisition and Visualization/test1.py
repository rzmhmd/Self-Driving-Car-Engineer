...
def detect_objects(input_bev_maps, model, configs):
    ...
    for obj in detections:
        ...
        x = obj[2] / configs.bev_height * (configs.lim_x[1] - configs.lim_x[0])
        y = obj[1] / configs.bev_width * \
            (configs.lim_y[1] - configs.lim_y[0]) - \
            (configs.lim_y[1] - configs.lim_y[0]) / 2
        w = obj[5] / configs.bev_width * (configs.lim_y[1] - configs.lim_y[0])
        l = obj[6] / configs.bev_height * (configs.lim_x[1] - configs.lim_x[0])
        z = obj[3]
        yaw = obj[7]

        # step 4 : append the current object to the 'objects' array
        objects.append([1, x, y, z, obj[4], w, l, yaw])
    #     x = obj[2] / configs.bev_height * (configs.lim_x[1] - configs.lim_x[0])
    # objects = [([1, x, y, z, _h, w, l, yaw]) for obj in detections]
    #######
    ####### ID_S3_EX2 START #######
