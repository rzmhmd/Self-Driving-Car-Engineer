...
int main()
{
    ...
    vector<vector<float>> sensor_obs{{1, 7, 12, 21}, {0, 6, 11, 20}, {5, 10, 19}, {4, 9, 18}, {3, 8, 17}, {2, 7, 16}, {1, 6, 15}, {0, 5, 14}, {4, 13}, {3, 12}, {2, 11}, {1, 10}, {0, 9}, {8}, {7}, {6}, {5}, {4}, {3}, {2}, {1}, {0}, {}, {}, {}};
    ...
    for (int t = 0; t < time_steps; ++t)
    {
        ...
        for (unsigned int i = 0; i < map_size; ++i)
        {
             ...
             */
            float motion_probability = motion_model(pseudo_position,
            ...
            pseudo_ranges = pseudo_range_estimator(landmark_positions,
                                                   pseudo_position);
            /**
            ...
            observation_probability = observation_model(landmark_positions,
                                                        observations,
                                                        pseudo_ranges,
                                                        distance_max,
                                                        observation_stdev);
            ...
            posteriors[i] = motion_probability * observation_probability;
            // UNCOMMENT TO SEE THIS STEP OF THE FILTER
        ...
        std::vector<float> normalized_posteriors;
        normalized_posteriors = Helpers::normalize_vector(posteriors);
