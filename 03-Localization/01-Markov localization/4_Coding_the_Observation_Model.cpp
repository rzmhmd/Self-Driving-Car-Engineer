                        ...
                        float distance_max, float observation_stdev)
{
  ...
  {
    // if (i <= pseudo_ranges.size())
    // {
    //   distance_prob *= Helpers::normpdf(observations[i], pseudo_ranges[i], observation_stdev);
    // }
    // else
    // {
    //   distance_prob *= Helpers::normpdf(observations[i],
    //                                     std::numeric_limits<const float>::infinity(), observation_stdev);
    // }
